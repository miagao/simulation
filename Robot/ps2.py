...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        try:
            ...
            print '"%s" or "%s" cannot be converted to an int: %s' % (width, height, ex)
    ...
    def getNumCleanedTiles(self):
        ...
        returns: an integer
        """
        return sum(1 for tile in self.tiles if self.tiles[tile] == True)
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        while not self.room.isPositionInRoom(new_position):
            # change directon and try new position 
...
#print  runSimulation(1, 1.0, 10, 10, 0.75, 300, StandardRobot)
#print  runSimulation(1, 1.0, 10, 10, 0.9, 300, StandardRobot)
#print  runSimulation(1, 1.0, 20, 20, 1, 300, StandardRobot)
...
#     plot.
#
#showPlot1('titulo', 'xlabel','ylabel')
#
...
#     plot.
#
showPlot2('titulo', 'xlabel','ylabel')
